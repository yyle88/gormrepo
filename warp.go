...
// Mold sets the default model template (MOD) for the GormRepo, applying it to the DB instance.
// Returns a new GormRepo instance for chainable operations.
func (repo *GormRepo[MOD, CLS]) Mold() *GormRepo[MOD, CLS] {
	return NewGormRepo(repo.db.Model((*MOD)(nil)), (*MOD)(nil), repo.cls)
}

// Mold sets the default model template (MOD) for the GormWrap, applying it to the DB instance.
// Returns a new GormWrap instance for chainable operations.
...
// Parameters:
//   - ctx: The context to apply for database operations.
//
// Returns a new GormRepo instance for chainable operations.
...
// WithContext sets the context for the GormWrap, applying it to the DB instance.
// Parameters:
//   - ctx: The context to apply for database operations.
//
// Returns a new GormWrap instance for chainable operations.
