...
// UsePlain returns the model (`mod`) and its associated columns (`cls`) without table name prefix, suitable for queries or operations that need both.
...
// UmcPlain returns the model (mod) and the associated columns (cls) without table name prefix, functioning the same as the UsePlain function.
